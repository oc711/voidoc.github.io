...
公式：$l_1:\Omega \left ( \omega  \right ) =\lvert\lvert w \lvert\lvert _1=\sum_{i}^{} \lvert w_i \lvert  $   
* L2正则化是根据权重的平方和来惩罚权重。   
公式：$l_2:\Omega \left ( \omega  \right ) =\lvert\lvert w \lvert\lvert _2^2=\sum_{i}^{} \lvert w_i^2 \lvert $  
