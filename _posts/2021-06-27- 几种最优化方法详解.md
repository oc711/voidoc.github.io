...
* 计算梯度$\bigtriangledown f\left ( x \right ) =\begin{bmatrix}
\frac{\partial f}{\partial x_{1}}  \\\frac{\partial f}{\partial x_{2}} \end{bmatrix}=\begin{bmatrix}
x_{1}\\9x_{2}\end{bmatrix} $  
* 计算海塞矩阵$Hf\left ( x \right ) =\begin{bmatrix}
...
\end{bmatrix}=\begin{bmatrix}
 ...
 0 &9
\end{bmatrix}$  
* 所以$x^{1}=x^{0} -\frac{\bigtriangledown f\left ( x^{0} \right ) }{H\left ( f\left ( x^{0} \right )  \right ) }=\begin{bmatrix}
 9\\1 \end{bmatrix}$ - \begin{bmatrix}1&0 \\0&9\end{bmatrix}^{-1}\begin{bmatrix}
